function [xyzPoints,camPoses,reprojectionErrors] = getMatchingRelationshipAnd3dPointSpec_CamPose(images,resultArray,matchPaarset,intrinsics,CameraPosition)
...
%     currPoints = detectSURFFeatures(I, 'NumOctaves', 3);
    ...
    if i > 1
        ...
        % 
        x1 = CameraPosition{bestMatchedIndex,2};   
        y1 = CameraPosition{bestMatchedIndex,3};
        z1 = CameraPosition{bestMatchedIndex,4};
        % 
